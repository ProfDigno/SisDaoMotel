...
//    private static boolean es_consumo;
    ...
    private void cargar_datos_caja(Connection conn, int fk_idcaja_cierre) {
        ...
        String sql = "select cci.fk_idcaja_cierre as fk_idcaja_cierre,\n"
                ...
                + "TRIM(to_char(sum((cd.monto_solo_adelanto+cd.monto_ocupa_minimo+cd.monto_ocupa_adicional+cd.monto_ocupa_consumo)-\n"
    ...
    private void cargar_datos_item_caja_detalle(Connection conn, int fk_idcaja_cierre) {
        ...
        String sql = "select cd.idcaja_cierre_detalle as idc,\n"
                ...
                + "TRIM(to_char(cd.monto_ocupa_consumo,'999G999G999')) as m_consumo,\n"
                + "TRIM(to_char(((cd.monto_solo_adelanto+cd.monto_ocupa_minimo+cd.monto_ocupa_adicional+cd.monto_ocupa_consumo)-\n"
                + "(cd.monto_ocupa_descuento+cd.monto_ocupa_adelanto)),'999G999G999')) as tt_ingreso\n"
                + "from caja_cierre_detalle cd,caja_cierre_item cci,caja_cierre cca\n"
                + "where  cd.idcaja_cierre_detalle=cci.fk_idcaja_cierre_detalle\n"
                + "and cci.fk_idcaja_cierre=cca.idcaja_cierre \n"
    ...
    private static void crear_archivo_texto_impresion() throws PrintException, FileNotFoundException, IOException {
        ...
        printer.printTextWrap(23 + tempfila, 23, jsprint.getSep_inicio(), totalColumna, "===>TOTAL INGRESO: ");
        printer.printTextWrap(23 + tempfila, 23, jsprint.getSep_total_gral(), totalColumna, pos.alinearDerecha(cd_tt_ingreso, cant_char));
        printer.printTextWrap(24 + tempfila, 24, jsprint.getSep_inicio(), totalColumna, jsprint.getLinea_separador());
        printer.printTextWrap(25 + tempfila, 25, jsprint.getSep_inicio(), totalColumna, "###-DATOS EGRESO-###");
        printer.printTextWrap(26 + tempfila, 26, jsprint.getSep_inicio(), totalColumna, "TT. COMPRA : ");
        printer.printTextWrap(26 + tempfila, 26, jsprint.getSep_item_subtotal(), totalColumna, pos.alinearDerecha(cd_tt_compra, cant_char));
        printer.printTextWrap(27 + tempfila, 27, jsprint.getSep_inicio(), totalColumna, "TT. VALE : ");
        printer.printTextWrap(27 + tempfila, 27, jsprint.getSep_item_subtotal(), totalColumna, pos.alinearDerecha(cd_tt_vale, cant_char));
        printer.printTextWrap(28 + tempfila, 28, jsprint.getSep_inicio(), totalColumna, "TT. LIQUIDACION : ");
        printer.printTextWrap(28 + tempfila, 28, jsprint.getSep_item_subtotal(), totalColumna, pos.alinearDerecha(cd_tt_liquida, cant_char));
        printer.printTextWrap(29 + tempfila, 29, jsprint.getSep_inicio(), totalColumna, "TT. GASTO : ");
        printer.printTextWrap(29 + tempfila, 29, jsprint.getSep_item_subtotal(), totalColumna, pos.alinearDerecha(cd_tt_gasto, cant_char));
        printer.printTextWrap(30 + tempfila, 30, jsprint.getSep_inicio(), totalColumna, "===>TOTAL EGRESO : ");
        printer.printTextWrap(30 + tempfila, 30, jsprint.getSep_total_gral(), totalColumna, pos.alinearDerecha(cd_tt_egreso, cant_char));
        printer.printTextWrap(31 + tempfila, 31, jsprint.getSep_inicio(), totalColumna, jsprint.getLinea_separador());
        printer.printTextWrap(32 + tempfila, 32, jsprint.getSep_inicio(), totalColumna, "===>TOTAL SALDO : ");
        printer.printTextWrap(32 + tempfila, 32, jsprint.getSep_total_gral(), totalColumna, pos.alinearDerecha(cd_tt_saldo, cant_char));
