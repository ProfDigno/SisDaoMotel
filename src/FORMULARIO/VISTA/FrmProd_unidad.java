 ...
 * @author Digno
 */
public class FrmProd_unidad extends javax.swing.JInternalFrame {
    ...
    private BO_producto_unidad BOpu=new BO_producto_unidad();
    ...
    private void cargar_dato(){
        ...
        ENTpu.setC5orden(0);
        ENTpu.setC6activo(jCactivo.isSelected());
    }
    private void boton_guardar() {
        if (validar_guardar()) {
            cargar_dato();
            BOpu.insertar_producto_unidad(ENTpu, tbltabla_pri);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            ENTpu.setC1idproducto_unidad(Integer.parseInt(txtid.getText()));
            cargar_dato();
            BOpu.update_producto_unidad(ENTpu, tbltabla_pri);
        }
    }

    private void seleccionar_tabla() {
        int id = eveJtab.getInt_select_id(tbltabla_pri);
        DAOpu.cargar_producto_unidad(conn, ENTpu, id);
        txtid.setText(String.valueOf(ENTpu.getC1idproducto_unidad()));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAOpu.ancho_tabla_producto_unidad(tbltabla_pri);
...
//        evejtf.saltar_campo_enter(evt, txtnombre, txtprecio_venta);
    ...
    private void txtbuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarKeyReleased
        // TODO add your handling code here:
//        DAOgt.actualizar_tabla_producto_unidad_buscar(conn, tbltabla_pri, txtbuscar);
