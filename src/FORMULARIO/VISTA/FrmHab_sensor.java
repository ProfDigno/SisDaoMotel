 ...
 * @author Digno
 */
public class FrmHab_sensor extends javax.swing.JInternalFrame {

    private EvenJFRAME evetbl = new EvenJFRAME();
    private EvenJtable eveJtab = new EvenJtable();
    private habitacion_sensor ENTgt=new habitacion_sensor();
    ...
    private void cargar_dato(){
        ...
        ENTgt.setC5es_digital_entrada(jCdigital_entrada.isSelected());
        ENTgt.setC6es_digital_salida(jCdigital_salida.isSelected());
        ENTgt.setC7activo(jCactivo.isSelected());
    }
    private void boton_guardar() {
        if (validar_guardar()) {
            cargar_dato();
            BOgt.insertar_habitacion_sensor(ENTgt, tbltabla_pri);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            ENTgt.setC1idhabitacion_sensor(Integer.parseInt(txtid.getText()));
            cargar_dato();
            BOgt.update_habitacion_sensor(ENTgt, tbltabla_pri);
        }
    }

    private void seleccionar_tabla() {
        int id = eveJtab.getInt_select_id(tbltabla_pri);
        DAOgt.cargar_habitacion_sensor(conn, ENTgt, id);
        txtid.setText(String.valueOf(ENTgt.getC1idhabitacion_sensor()));
        txtnombre.setText(ENTgt.getC4nombre());
        jCdigital_entrada.setSelected(ENTgt.getC5es_digital_entrada());
    ...
    private void initComponents() {
        ...
        jCdigital_entrada = new javax.swing.JCheckBox();
        jCdigital_salida = new javax.swing.JCheckBox();
        ...
        jCdigital_entrada.setText("DIGITAL ENTRADA");

        jCdigital_salida.setText("DIGITAL SALIDA");
        ...
        panel_insertarLayout.setHorizontalGroup(
            ...
            .addGroup(panel_insertarLayout.createSequentialGroup()
                ...
                .addGroup(panel_insertarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panel_insertarLayout.createSequentialGroup()
                        .addGroup(panel_insertarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jCdigital_entrada)
                            .addComponent(jCdigital_salida))
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAOgt.ancho_tabla_habitacion_sensor(tbltabla_pri);
...
//        evejtf.saltar_campo_enter(evt, txtnombre, txtprecio_venta);
    ...
    private void txtbuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarKeyReleased
        // TODO add your handling code here:
//        DAOgt.actualizar_tabla_habitacion_sensor_buscar(conn, tbltabla_pri, txtbuscar);
    ...
    private javax.swing.JCheckBox jCdigital_entrada;
    private javax.swing.JCheckBox jCdigital_salida;
