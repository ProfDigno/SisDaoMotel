...
public class FrmGasto_Tipo extends javax.swing.JInternalFrame {
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            cargar_dato();
            BOgt.insertar_gasto_tipo(ENTgt, tbltabla_pri);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            ...
            cargar_dato();
            BOgt.update_gasto_tipo(ENTgt, tbltabla_pri);
        }
    }
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAOgt.ancho_tabla_gasto_tipo(tbltabla_pri);
...
//        evejtf.saltar_campo_enter(evt, txtnombre, txtprecio_venta);
    ...
    private void txtbuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarKeyReleased
        // TODO add your handling code here:
        DAOgt.actualizar_tabla_gasto_tipo_buscar(conn, tbltabla_pri, txtbuscar);
