 ...
 * @author Digno
 */
public class FrmPatrimonio_categoria extends javax.swing.JInternalFrame {
    ...
    private BO_patrimonio_categoria BOpc=new BO_patrimonio_categoria();
    private EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    usuario ENTusu = new usuario();
    private String nombreTabla_pri="PATRIMONIO CATEGORIA"; 
    ...
    private void abrir_formulario() {
        ...
        reestableser();
        DAOpc.actualizar_tabla_patrimonio_categoria(conn, tbltabla_pri);
    }
    ...
    private void cargar_dato(){
        ...
        ENTpc.setC4nombre(txtnombre.getText());
        ENTpc.setC5activo(jCactivo.isSelected());
    }
    private void boton_guardar() {
        if (validar_guardar()) {
            cargar_dato();
            BOpc.insertar_patrimonio_categoria(ENTpc, tbltabla_pri);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            ENTpc.setC1idpatrimonio_categoria(Integer.parseInt(txtid.getText()));
            cargar_dato();
            BOpc.update_patrimonio_categoria(ENTpc, tbltabla_pri);
        }
    }

    private void seleccionar_tabla() {
        int id = eveJtab.getInt_select_id(tbltabla_pri);
        DAOpc.cargar_patrimonio_categoria(conn, ENTpc, id);
        txtid.setText(String.valueOf(ENTpc.getC1idpatrimonio_categoria()));
        txtnombre.setText(ENTpc.getC4nombre());
        jCactivo.setSelected(ENTpc.getC5activo());
    ...
    public FrmPatrimonio_categoria() {
        initComponents();
        abrir_formulario();
    }
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAOpc.ancho_tabla_patrimonio_categoria(tbltabla_pri);
