 ...
 * @author Digno
 */
public class FrmProd_categoria extends javax.swing.JInternalFrame {
    ...
    private String nombreTabla_pri="CATEGORIA"; 
    ...
    private void abrir_formulario() {
        ...
        reestableser();
        DAOpc.actualizar_tabla_producto_categoria(conn, tbltabla_pri);
    }
    ...
    private void cargar_dato(){
        ...
        ENTpc.setC5orden(0);
        ENTpc.setC6activo(jCactivo.isSelected());
        ENTpc.setC7es_venta(jCesventa.isSelected());
    }
    private void boton_guardar() {
        if (validar_guardar()) {
            cargar_dato();
            BOpc.insertar_producto_categoria(ENTpc, tbltabla_pri);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            ...
            cargar_dato();
            BOpc.update_producto_categoria(ENTpc, tbltabla_pri);
        }
    }
    ...
    private void seleccionar_tabla() {
        ...
        jCactivo.setSelected(ENTpc.getC6activo());
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAOpc.ancho_tabla_producto_categoria(tbltabla_pri);
...
//        evejtf.saltar_campo_enter(evt, txtnombre, txtprecio_venta);
    ...
    private void txtbuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarKeyReleased
        // TODO add your handling code here:
//        DAOgt.actualizar_tabla_producto_categoria_buscar(conn, tbltabla_pri, txtbuscar);
