 ...
 * @author Digno
 */
public class FrmUsuario_tipo_evento extends javax.swing.JInternalFrame {
    ...
    private BO_usuario_tipo_evento BOute=new BO_usuario_tipo_evento();
//    private DAO_producto DAOp = new DAO_producto();
    ...
    private void abrir_formulario() {
        ...
        reestableser();
        DAOute.actualizar_tabla_usuario_tipo_evento(conn, tbltabla_pri);
    }
    ...
    private void cargar_dato(){
        ENTute.setC3creado_por(creado_por);
        ENTute.setC4nombre(txtnombre.getText());
    }
    private void boton_guardar() {
        if (validar_guardar()) {
            cargar_dato();
            BOute.insertar_usuario_tipo_evento(ENTute, tbltabla_pri);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            ENTute.setC1idusuario_tipo_evento(Integer.parseInt(txtid.getText()));
            cargar_dato();
            BOute.update_usuario_tipo_evento(ENTute, tbltabla_pri);
        }
    }

    private void seleccionar_tabla() {
        int id = eveJtab.getInt_select_id(tbltabla_pri);
        DAOute.cargar_usuario_tipo_evento(conn, ENTute, id);
        txtid.setText(String.valueOf(ENTute.getC1idusuario_tipo_evento()));
        txtnombre.setText(ENTute.getC4nombre());
        titulo_formulario(ENTute.getC2fecha_creado(), ENTute.getC3creado_por());
        String filtro="and pm.idusuario_tipo_evento="+ENTute.getC1idusuario_tipo_evento();
//        DAOp.actualizar_tabla_producto(conn, tbltabla_sec, filtro,"3","");
    ...
    private void initComponents() {
        ...
        txtnombre.setBorder(javax.swing.BorderFactory.createTitledBorder("NOMBRE TIPO EVENTO:"));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAOute.ancho_tabla_usuario_tipo_evento(tbltabla_pri);
