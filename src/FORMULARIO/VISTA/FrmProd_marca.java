 ...
 * @author Digno
 */
public class FrmProd_marca extends javax.swing.JInternalFrame {
    ...
    private void abrir_formulario() {
        ...
        reestableser();
        DAOpm.actualizar_tabla_producto_marca(conn, tbltabla_pri);
    }
    ...
    private void cargar_dato(){
        ENTpm.setC3creado_por(creado_por);
        ENTpm.setC4nombre(txtnombre.getText());
        ENTpm.setC5orden(0);
        ENTpm.setC6activo(jCactivo.isSelected());
    }
    private void boton_guardar() {
        if (validar_guardar()) {
            cargar_dato();
            BOpm.insertar_producto_marca(ENTpm, tbltabla_pri);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            ENTpm.setC1idproducto_marca(Integer.parseInt(txtid.getText()));
            cargar_dato();
            BOpm.update_producto_marca(ENTpm, tbltabla_pri);
        }
    }

    private void seleccionar_tabla() {
        int id = eveJtab.getInt_select_id(tbltabla_pri);
        DAOpm.cargar_producto_marca(conn, ENTpm, id);
        txtid.setText(String.valueOf(ENTpm.getC1idproducto_marca()));
        txtnombre.setText(ENTpm.getC4nombre());
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAOpm.ancho_tabla_producto_marca(tbltabla_pri);
