...
//    private DAO_producto DAOp = new DAO_producto();
    ...
    private void abrir_formulario() {
        ...
        reestableser();
        DAOb.actualizar_tabla_banco(conn, tbltabla_pri);
    }
    ...
    private void cargar_dato(){
        ENTb.setC3creado_por(creado_por);
        ENTb.setC4nombre(txtnombre.getText());
    }
    private void boton_guardar() {
        if (validar_guardar()) {
            cargar_dato();
            BOb.insertar_banco(ENTb, tbltabla_pri);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            ENTb.setC1idbanco(Integer.parseInt(txtid.getText()));
            cargar_dato();
            BOb.update_banco(ENTb, tbltabla_pri);
        }
    }

    private void seleccionar_tabla() {
        int id = eveJtab.getInt_select_id(tbltabla_pri);
        DAOb.cargar_banco(conn, ENTb, id);
        txtid.setText(String.valueOf(ENTb.getC1idbanco()));
        txtnombre.setText(ENTb.getC4nombre());
        titulo_formulario(ENTb.getC2fecha_creado(), ENTb.getC3creado_por());
        String filtro="and pm.idbanco="+ENTb.getC1idbanco();
//        DAOp.actualizar_tabla_producto(conn, tbltabla_sec, filtro,"3","");
    ...
    private void initComponents() {
        ...
        txtnombre.setBorder(javax.swing.BorderFactory.createTitledBorder("NOMBRE BANCO:"));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAOb.ancho_tabla_banco(tbltabla_pri);
