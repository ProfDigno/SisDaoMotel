 ...
 * @author Digno
 */
public class FrmCompra_reposicion extends javax.swing.JInternalFrame {
...
//    private EvenEstado eveest = new EvenEstado();
    ...
    private void precargar_producto(int idproducto) {
        ...
        String precio_compra=ENTp.getPrecio_compra_mostrar().replace(',', '.');
        precio_compra_mostrar = precio_compra;
        ...
        txtprecio_compra.setText(precio_compra_mostrar);
        txtprecio_compra.setBackground(Color.white);
    ...
    private void cargar_item_producto(boolean cargar_auto) {
        ...
        if (validar) {
            ...
            String Sprecio_compra1 = precio_compra_mostrar;
            ...
            if(modifico_precio_compra){
                Sprecio_compra1=txtprecio_compra.getText();
                Sprecio_compra=Sprecio_compra1.replace(".","");
                Double Dprecio_compra=Double.parseDouble(Sprecio_compra);
                ENTp.setC1idproducto(idproducto);
                ENTp.setC12precio_compra(Dprecio_compra);
                DAOp.update_producto_precio_compra(conn, ENTp);
            }
            String dato[] = {Sidproducto, Sdescripcion, Sprecio_compra1, Scantidad, Ssubtotal, Sprecio_venta2, Sprecio_compra, Stipo, Ssubtotal2, Siva};
    ...
    private void seleccionar_compra() {
        if (tblcompra.getSelectedRow() >= 0) {
            ...
            if (estado.equals(eveest.getEst_Anulado())) {
                ...
                btncom_cargadostock.setEnabled(false);
                btncom_recargar.setEnabled(true);
            }
            if (estado.equals(eveest.getEst_CARGADOSTOCK())) {
                btncom_anular.setEnabled(false);
                btncom_cargadostock.setEnabled(false);
            ...
            if (estado.equals(eveest.getEst_PENDIENTE())) {
                ...
                btncom_cargadostock.setEnabled(true);
                btncom_recargar.setEnabled(false);
            }
        }
    ...
    public String filtro_estado(JCheckBox jCest_pendiente, JCheckBox jCest_cargadostock,
        ...
        if (jCest_cargadostock.isSelected()) {
            contestado++;
            if (contestado == 1) {
                condi = " and(";
                fin = ") ";
            ...
            estado = condi + " c.estado='" + eveest.getEst_CARGADOSTOCK() + "' ";
            sumaestado = sumaestado + estado;
        }
    ...
    private String getfiltro_compra() {
        ...
        filtro_est = filtro_estado(jCest_pendiente, jCest_cargadostock, jCest_anulado);
        if (idusuario > 0) {
    ...
    private void recargar_compra_item(int idcompra) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                precio_compra_mostrar = rs.getString("pcompra");
    ...
    private void initComponents() {
        ...
        txtprecio_compra.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtprecio_compra.setBorder(javax.swing.BorderFactory.createTitledBorder("PRECIO"));
        ...
        jTextField1.setText("CARGAR STOCK");
        ...
        txtnro_factura.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtnro_factura, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txtidcompra, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtproveedor_nombre)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtproveedor_ruc, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnbuscar_persona, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        btncom_cargadostock.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btncom_cargadostock.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        btncom_cargadostock.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btncom_cargadostockActionPerformed(evt);
            }
        });
        ...
        jCest_cargadostock.setText("CARGADO STOCK");
        jCest_cargadostock.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCest_cargadostockActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jCest_cargadostock)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btncom_cargadostock)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(btncom_cargadostock, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btncom_cargadostockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncom_cargadostockActionPerformed
        // TODO add your handling code here:
        boton_pagar_compra();
    }//GEN-LAST:event_btncom_cargadostockActionPerformed
    ...
    private void jCest_cargadostockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCest_cargadostockActionPerformed
        // TODO add your handling code here:
        actualizar_tabla_compra();
    }//GEN-LAST:event_jCest_cargadostockActionPerformed
    ...
    private void txtprecio_compraKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtprecio_compraKeyReleased
        // TODO add your handling code here:
        evejtf.getString_format_nro_entero1(txtprecio_compra);
        txtprecio_compra.setBackground(Color.gray);
        txtprecio_compra.setForeground(Color.yellow);
    ...
    private javax.swing.JButton btncom_cargadostock;
    ...
    private javax.swing.JCheckBox jCest_cargadostock;
