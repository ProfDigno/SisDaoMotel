 ...
 * @author Digno
 */
public class FrmRepVale extends javax.swing.JInternalFrame {

    private String nombre_formulario = "REPORTE VALE";
    ...
    private DAO_rh_vale DAOv = new DAO_rh_vale();
    ...
    private void actualizar_tabla() {
        ...
        double monto_consumo = evejt.getDouble_sumar_tabla(tblvale, 15);
        double monto_total = evejt.getDouble_sumar_tabla(tblvale, 16);
        jFmonto_guarani.setValue(monto_consumo);
        int cant = tblvale.getRowCount();
    ...
    private void tabla_grupo() {
        ...
        if (tipo_seleccionar_grupo == 1) {
            sql = "select p.idpersona as idp,(p.nombre||'-'||p.ruc) as persona,\n"
                    + "TRIM(to_char(sum(v.monto_vale),'999G999G999')) as monto\n"
    ...
    private void tabla_vale() {
        String sql = "select v.idrh_vale as idv,to_char(v.fecha_creado,'yyyy-MM-dd') as fecha,\n"
                ...
                + " order by 2 desc";
        actualizar_tabla_vale(conn, tblvale, sql);
        double sum_guarani = evejt.getDouble_sumar_tabla(tblvale, 6);
    ...
    private void actualizar_tabla_vale_grupo(Connection conn, JTable tbltabla, String sql) {
        ...
        ancho_tabla_vale_grupo(tbltabla);
    }

    private void ancho_tabla_vale_grupo(JTable tbltabla) {
        int Ancho[] = {1, 80, 20};
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(180, 180, 180)
                .addComponent(jFmonto_guarani, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))
