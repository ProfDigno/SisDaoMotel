 ...
 * @author Digno
 */
public class FrmPatrimonio_ubicacion extends javax.swing.JInternalFrame {
    ...
    private BO_patrimonio_ubicacion BOpu=new BO_patrimonio_ubicacion();
    private EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    usuario ENTusu = new usuario();
    private String nombreTabla_pri="PATRIMONIO UBICACION"; 
    ...
    private void abrir_formulario() {
        ...
        reestableser();
        DAOpu.actualizar_tabla_patrimonio_ubicacion(conn, tbltabla_pri);
    }
    ...
    private void cargar_dato(){
        ENTpu.setC3creado_por(creado_por);
        ENTpu.setC4nombre(txtnombre.getText());
        ENTpu.setC5activo(jCactivo.isSelected());
    }
    private void boton_guardar() {
        if (validar_guardar()) {
            cargar_dato();
            BOpu.insertar_patrimonio_ubicacion(ENTpu, tbltabla_pri);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            ENTpu.setC1idpatrimonio_ubicacion(Integer.parseInt(txtid.getText()));
            cargar_dato();
            BOpu.update_patrimonio_ubicacion(ENTpu, tbltabla_pri);
        }
    }

    private void seleccionar_tabla() {
        int id = eveJtab.getInt_select_id(tbltabla_pri);
        DAOpu.cargar_patrimonio_ubicacion(conn, ENTpu, id);
        txtid.setText(String.valueOf(ENTpu.getC1idpatrimonio_ubicacion()));
        txtnombre.setText(ENTpu.getC4nombre());
        jCactivo.setSelected(ENTpu.getC5activo());
    ...
    public FrmPatrimonio_ubicacion() {
        initComponents();
        abrir_formulario();
    }
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAOpu.ancho_tabla_patrimonio_ubicacion(tbltabla_pri);
...
//        evejtf.saltar_campo_enter(evt, txtnombre, txtprecio_venta);
    ...
    private void txtbuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarKeyReleased
        // TODO add your handling code here:
//        DAOgt.actualizar_tabla_patrimonio_ubicacion_buscar(conn, tbltabla_pri, txtbuscar);
