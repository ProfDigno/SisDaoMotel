 ...
 * @author Digno
 */
public class FrmUsuario_Formulario extends javax.swing.JInternalFrame {
...
//    private DAO_producto DAOp = new DAO_producto();
    ...
    private void abrir_formulario() {
        ...
        reestableser();
        DAOuf.actualizar_tabla_usuario_formulario(conn, tbltabla_pri);
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            cargar_dato();
            BOuf.insertar_usuario_formulario(ENTuf, tbltabla_pri);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            ENTuf.setC1idusuario_formulario(Integer.parseInt(txtid.getText()));
            cargar_dato();
            BOuf.update_usuario_formulario(ENTuf, tbltabla_pri);
        }
    }

    private void seleccionar_tabla() {
        int id = eveJtab.getInt_select_id(tbltabla_pri);
        DAOuf.cargar_usuario_formulario(conn, ENTuf, id);
        txtid.setText(String.valueOf(ENTuf.getC1idusuario_formulario()));
        txtnombre.setText(ENTuf.getC4nombre());
        titulo_formulario(ENTuf.getC2fecha_creado(), ENTuf.getC3creado_por());
        String filtro="and pm.idusuario_formulario="+ENTuf.getC1idusuario_formulario();
//        DAOp.actualizar_tabla_producto(conn, tbltabla_sec, filtro,"3","");
    ...
    private void initComponents() {
        ...
        txtnombre.setBorder(javax.swing.BorderFactory.createTitledBorder("NOMBRE FORMULARIO:"));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAOuf.ancho_tabla_usuario_formulario(tbltabla_pri);
