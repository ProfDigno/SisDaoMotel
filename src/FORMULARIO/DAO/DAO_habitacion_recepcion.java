...
public class DAO_habitacion_recepcion {
    ...
    public void update_habitacion_recepcion(Connection conn, habitacion_recepcion hare) {
        ...
        try {
            ...
            pst.setTimestamp(1, evefec.getTimestamp_fecha_cargado(hare.getC2fecha_creado()));
            pst.setString(2, hare.getC3creado_por());
            pst.setString(3, hare.getC4estado());
            pst.setInt(4, hare.getC5nro_habitacion());
            pst.setTimestamp(5, evefec.getTimestamp_fecha_cargado(hare.getC6fec_libre_inicio()));
            pst.setTimestamp(6, evefec.getTimestamp_fecha_cargado(hare.getC7fec_libre_fin()));
            pst.setTimestamp(7, evefec.getTimestamp_fecha_cargado(hare.getC8fec_ocupado_inicio()));
            pst.setTimestamp(8, evefec.getTimestamp_fecha_cargado(hare.getC9fec_ocupado_fin()));
            pst.setTimestamp(9, evefec.getTimestamp_fecha_cargado(hare.getC10fec_sucio_inicio()));
            pst.setTimestamp(10, evefec.getTimestamp_fecha_cargado(hare.getC11fec_sucio_fin()));
            pst.setTimestamp(11, evefec.getTimestamp_fecha_cargado(hare.getC12fec_limpieza_inicio()));
            pst.setTimestamp(12, evefec.getTimestamp_fecha_cargado(hare.getC13fec_limpieza_fin()));
            pst.setTimestamp(13, evefec.getTimestamp_fecha_cargado(hare.getC14fec_mante_inicio()));
            pst.setTimestamp(14, evefec.getTimestamp_fecha_cargado(hare.getC15fec_mante_fin()));
