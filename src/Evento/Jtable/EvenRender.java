...
//                String STerminado = eveest.getEst_Terminar();
    ...
    public void rendertabla_venta_producto(JTable tbltabla, final int columna) {
        ...
        tbltabla.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table,
                ...
                String Stiene_stock = "NO";
                if (Otiene_stock != null && Stiene_stock.equals(Otiene_stock.toString())) {
                    color_fondo = Color.YELLOW;
                    color_text = Color.RED;
                }
